export const experience = [
  {
    ...
    lastExp: [
      {
        id: 0,
        title: { en: "Yandex Practicum", ru: "Яндекс Практикум" },
        time: { en: "2019-2021", ru: "2019-2021" },
        description: {
          en: "I have been studied at Yandex Practicum. I took two courses, a web developer and a react developer. I have been received two diplomas on completion of courses, and was also able to delve into the profession in detail and deeply, which allowed him to become a Junior developer.",
          ru: "Я проходил обучение на практикуме Яндекса. Прошел два курса: веб-разработчик и react-разработчик, и получил два диплома по окончании курсов, а также смог подробно и глубоко вникнуть в профессию, что позволило мне стать middle-разработчиком.",
        },
      },
      {
        id: 1,
